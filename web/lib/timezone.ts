// Source - https://stackoverflow.com/a/52265733
// Posted by hobberwickey, modified by community. See post 'Timeline' for change history
...
export const TIME_ZONE_STORAGE_KEY = "sports-calendar.timeZone";

const SUPPORTED_TIME_ZONES = new Set(tzStrings.map((entry) => entry.value));
...
export function isSupportedTimeZone(value: string) {
  ...
  if (value === SERVER_TIME_ZONE || SUPPORTED_TIME_ZONES.has(value)) {
    return true;
  }
